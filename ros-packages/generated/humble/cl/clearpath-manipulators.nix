...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ clearpath-manipulators-description gripper-controllers moveit-configs-utils moveit-kinematics moveit-planners moveit-planners-chomp moveit-ros-move-group moveit-ros-warehouse moveit-simple-controller-manager position-controllers tf2-ros xacro ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "clearpath_manipulators" = substituteSource {
      src = fetchgit {
        ...
        rev = "abf66623b9dd6d33195c4a4d3f74b139c2e5e07f";
        hash = "sha256-+BnASMdFl6qjOy5clIWikZCBTKFACye+UHmbzqHDngY=";
      };
    };
  });
  meta = {
