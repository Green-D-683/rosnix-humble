...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ depthai-descriptions kortex-description realsense2-description robotiq-description ur-description urdf xacro zed-msgs ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "husarion_components_description" = substituteSource {
      src = fetchgit {
        ...
        rev = "3bd45cf267623d9d8c52ce5409ab4e7b9bcb4479";
