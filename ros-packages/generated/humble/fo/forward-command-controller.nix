...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ backward-ros controller-interface generate-parameter-library hardware-interface pluginlib rclcpp rclcpp-lifecycle realtime-tools std-msgs ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "forward_command_controller" = substituteSource {
      src = fetchgit {
        ...
        rev = "b7b3412653b59579c2a286f21a6f725115ad998a";
        hash = "sha256-DPIXtRNaR3N35IhspHgtqTmqj/K5oRkB4b8K2sgSe0o=";
      };
    };
  });
  meta = {
