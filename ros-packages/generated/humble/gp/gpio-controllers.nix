...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ control-msgs controller-interface generate-parameter-library hardware-interface pluginlib rclcpp rclcpp-lifecycle realtime-tools ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "gpio_controllers" = substituteSource {
      src = fetchgit {
        ...
        rev = "c88d521568c9d0382637e003bf21b10770a1900b";
        hash = "sha256-ghPfp1g/HGe9g5ACr7uWpHP9o9oF8Rf7fHq6xNfx5Mc=";
      };
    };
  });
  meta = {
