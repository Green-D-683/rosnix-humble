...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ compressed-depth-image-transport compressed-image-transport theora-image-transport ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "image_transport_plugins" = substituteSource {
      src = fetchgit {
        ...
        rev = "bc534697f3027ca69a40f69da0244963656052d9";
        hash = "sha256-lpSt5Fx8FLccmSSpLtC5EEm+ImiWRmJARbADiVPZkUA=";
      };
    };
  });
  meta = {
