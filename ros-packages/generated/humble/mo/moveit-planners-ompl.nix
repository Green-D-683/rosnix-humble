...
buildAmentCmakePackage (finalAttrs: {
  ...
  checkInputs = [ ament-cmake-gtest ament-lint-auto ament-lint-common moveit-resources-fanuc-moveit-config moveit-resources-panda-moveit-config moveit-resources-pr2-description tf2-eigen ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "eigen" ]; };
  passthru.sources = mkSourceSet (sources: {
    "moveit_planners_ompl" = substituteSource {
      src = fetchgit {
        name = "moveit_planners_ompl-source";
        url = "https://github.com/ros2-gbp/moveit2-release.git";
        rev = "30ad05b4a169d9bf160a78712f6f7e5ca7da9f17";
        hash = "sha256-d7s53ExNbKBRwNKUwfk2xcWl/mHbr1x1Flc8c6ds7vE=";
      };
    };
  });
  meta = {
