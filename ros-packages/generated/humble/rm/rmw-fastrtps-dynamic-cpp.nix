...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ ament-cmake fastcdr fastrtps fastrtps-cmake-module rcpputils rcutils rmw rmw-dds-common rmw-fastrtps-shared-cpp rosidl-runtime-c rosidl-typesupport-fastrtps-c rosidl-typesupport-fastrtps-cpp rosidl-typesupport-introspection-c rosidl-typesupport-introspection-cpp ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rmw_fastrtps_dynamic_cpp" = substituteSource {
      src = fetchgit {
        ...
        rev = "f54f40f641d2914b5892784953a4f566dbc03aac";
        hash = "sha256-AakMLxDEC+qUeEovB7a46T28cOtkRCYg6L2ad+VD0MQ=";
      };
    };
  });
  meta = {
