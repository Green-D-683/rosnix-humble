...
buildAmentCmakePackage (finalAttrs: {
  pname = "open_manipulator_x_gui";
  version = "3.0.4-1";
  src = finalAttrs.passthru.sources."open_manipulator_x_gui";
  ...
  passthru.sources = mkSourceSet (sources: {
    "open_manipulator_x_gui" = substituteSource {
      src = fetchgit {
        name = "open_manipulator_x_gui-source";
        url = "https://github.com/ros2-gbp/open_manipulator-release.git";
        rev = "0f7f0b6e9b481d05c9bae95a094e8d3f08b2ffb4";
        hash = "sha256-+395XOLHXYjtCHIHKToE98BCKm5Nq6k8MH93E+GGsSM=";
      };
    };
  });
  meta = {
