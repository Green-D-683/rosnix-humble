...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ action-tutorials-interfaces ament-index-cpp geometry-msgs rclcpp rclcpp-action rcpputils rosidl-runtime-cpp rosidl-typesupport-cpp rosidl-typesupport-introspection-cpp ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "ros_babel_fish" = substituteSource {
      src = fetchgit {
        ...
        rev = "937d204e06053fc24c347434f710994fb655e003";
        hash = "sha256-1Sap9ILD6zR7B19Lx2LXd7grwwtNsHo8MumZvZg1Oz0=";
      };
    };
  });
  meta = {
