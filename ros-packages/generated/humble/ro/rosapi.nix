...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ builtin-interfaces rcl-interfaces rclpy ros2action ros2interface ros2node ros2param ros2service ros2topic rosapi-msgs rosbridge-library rosidl-adapter rosidl-runtime-py ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rosapi" = substituteSource {
      src = fetchgit {
        ...
        rev = "cc550aac4ba07156ba50c4f5b621a0d3978cd3bf";
        hash = "sha256-thFN+KpAdWgJ/JFABRiybHj2P7PXtjTY0BYMBJm0FlU=";
      };
    };
  });
  meta = {
