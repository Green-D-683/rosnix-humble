  ...
  passthru.sources = mkSourceSet (sources: {
    "robot_calibration" = substituteSource {
      src = fetchgit {
        ...
        rev = "cb9888c2edfe75b7b862f2a5f3479296ff1b5a5a";
        hash = "sha256-0AYbhU4/NC+N0jjGY740XrT0m89vqhECoI1MbI5/1oY=";
      };
    };
  });
  meta = {
