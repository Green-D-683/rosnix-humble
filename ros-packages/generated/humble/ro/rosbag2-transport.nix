...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ keyboard-handler rclcpp rmw rosbag2-compression rosbag2-cpp rosbag2-interfaces rosbag2-storage shared-queues-vendor yaml-cpp-vendor ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rosbag2_transport" = substituteSource {
      src = fetchgit {
        ...
        rev = "99b08fdb22319991be305a159b90aa668d3d3e3d";
        hash = "sha256-xpZNm8g2ieznM/bAXVbWd1TwADwZUltBPUl1+H0qZtw=";
      };
    };
  });
  meta = {
