...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ ament-index-python camera-info-manager cv-bridge libcamera rclcpp rclcpp-components ros2launch sensor-msgs ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "camera_ros" = substituteSource {
      src = fetchgit {
        ...
        rev = "aad129cd07d1eec30f30df8bf55fe5bf438e310e";
