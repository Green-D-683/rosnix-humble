...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ ament-index-cpp camera-calibration-parsers rclcpp rcpputils sensor-msgs ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "camera_info_manager" = substituteSource {
      src = fetchgit {
        ...
        rev = "a64e20d16814398515e689479883396491705342";
        hash = "sha256-hg8MikWYxcbSaXMiaaZG9QxqMr1kuR8TaOg9jk0BKfY=";
      };
    };
  });
  meta = {
