...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ ackermann-msgs backward-ros builtin-interfaces controller-interface geometry-msgs hardware-interface nav-msgs pluginlib rclcpp rclcpp-lifecycle rcpputils realtime-tools std-srvs tf2 tf2-msgs ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "tricycle_controller" = substituteSource {
      src = fetchgit {
        ...
        rev = "5637b7d88f407f06b0d46f696fcf352c8ac75095";
        hash = "sha256-1z/nbYmS46AvqCNmVaxWNFczEt+K17MMaaBYY4eGnUU=";
      };
    };
  });
  meta = {
